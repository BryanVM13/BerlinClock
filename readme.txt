### Berlin Clock Kata #
Pour cette exercice, on a travaillé en partage d'écran sur Microsoft teams sur un seule pc et on utilisé la fonctionnalité de controle d'écran.
Chacun à notre tour avons développé les tests et fonctionnalités grâce au controle à distance de l'écran.
...
Afin d'obtenir une seule fois l'heure actuelle nous avons été obligé de stocker l'heure actuelle dans une variable qui se trouve tout à la fin.
...
nous avons une méthode qui renvoie un string cas par cas que nous avons du implémenter après avoir écrit le test unitaire correspondant.
